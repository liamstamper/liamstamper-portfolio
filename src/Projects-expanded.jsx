import Image1 from "./assets/gr-stocks-home.png";
const TutorialPage = ({ title, tags, date }) => {
  return (
              ...
              <div className="text-center">
                <div className="grid lg:grid-cols-2 gap-3">
                  <div className="grid grid-cols-2 lg:grid-cols-1 gap-3">
                    <img className="relative w-full h-60 bg-gray-300 rounded-xl" />
                    <img className="relative w-full h-60 bg-gray-300 rounded-xl" />
                  </div>
                  <img
                    src={Image1}
                    className="relative w-full h-72 sm:h-96 lg:h-full object-cover rounded-xl"
                  />
                </div>
              </div>
